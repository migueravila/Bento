...
const CONFIG = {
	...
	// Weather
	weatherKey: '5dd2c0882b2215ad65a37013949f63c2', // Write here your API Key
	weatherIcons: 'Dark', // 'Onedark', 'Nord', 'Dark', 'White'
	weatherUnit: 'F', // 'F', 'C'
	weatherLatitude: '29.760',
  	weatherLongitude: '-95.369',
	...
	firstButtonsContainer: [
		{
			id: '1',
			name: 'Texas A&M Canvas',
			icon: 'graduation-cap',
			link: 'https://canvas.tamu.edu/',
		},
		{
			id: '2',
			name: 'GMail',
